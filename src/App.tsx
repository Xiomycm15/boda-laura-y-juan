...
const invitationPresets: InvitationPreset[] = [
  ...
  {
    code: 'INV-018',
    slug: 'tio-carlos-mafe',
    slugAliases: ['tio-carlos', 'mafe'],
    label: 'Tío Carlos, Mafe & Aura',
    members: ['Tío Carlos', 'Mafe', 'Aura'],
    rsvpDeadline: '2026-09-10',
  },
  ...
  { code: 'INV-022', slug: 'tia-adri-dieguis', label: 'Tía Adri & Dieguis', members: ['Tía Adri', 'Dieguis'] },
  {
    code: 'INV-023',
    slug: 'tia-rosita',
    label: 'Tía Rosita & Yovan',
    members: ['Tía Rosita', 'Yovan'],
    rsvpDeadline: '2026-09-10',
  },
  ...
  },
  {
    code: 'INV-072',
    slug: 'marce-tito-tao',
    label: 'Marce, Tito & Tao',
    members: ['Marce', 'Tito', 'Tao'],
    rsvpDeadline: '2026-09-10',
  },
  {
    code: 'INV-073',
    slug: 'juan-pablo-andrea-gabi-mati',
    label: 'Juan Pablo, Andrea, Gabi & Mati',
    members: ['Juan Pablo', 'Andrea', 'Gabi', 'Mati'],
    rsvpDeadline: '2026-09-10',
  },
  {
    code: 'INV-074',
...
function downloadAdminReservationsWorkbook(reservations: AdminReservationRecord[]) {
  ...
  const hotelHeader = [
    ...
    'Valor por persona para x noches',
    'Total estimado del grupo',
    'Nombre asistente',
    'ID asistente',
    'Telefono asistente',
    'Correo asistente',
  ...
  reservationGroups.forEach((group) => {
    ...
    normalizedAttendees.forEach((attendee, index) => {
      ...
      const rowCells = isFirstAttendeeRow
        ...
        : [
            createMergedSpreadsheetCell(attendee.fullName, 0, false, 9),
            createMergedSpreadsheetCell(attendee.identityDocument),
            createMergedSpreadsheetCell(attendee.phone),
            createMergedSpreadsheetCell(attendee.email),
            createMergedSpreadsheetCell(attendee.allergies),
